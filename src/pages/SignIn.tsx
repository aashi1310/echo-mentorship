        ...
        <div className="w-full max-w-md">
          <Card>
            <CardHeader className="space-y-1">
              <CardTitle className="text-2xl font-bold text-center">Sign in to EchoMentor</CardTitle>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      to="/forgot-password"
                      className="text-sm font-medium text-echopurple-600 hover:text-echopurple-700 dark:text-echopurple-400 dark:hover:text-echopurple-300"
                    >
                      Forgot password?
                    </Link>
                  </div>
