...
const currentMentors = [
  {
    ...
    specialties: ["Career Transition", "Technical Interviews", "Leadership"],
    sessions: 8,
  ...
  },
  {
    ...
    specialties: ["Product Management", "UX Research", "Career Planning"],
    sessions: 3,
    lastSession: "1 week ago",
    nextSession: "Next Tuesday, 4:30 PM",
    image: "/placeholder.svg",
    rating: 4,
  },
];
